...
- **Tests/evidence:** clean install; `bun run typecheck`; empty test lanes; built CLI returns version/help without reading config; package-manager and Bun versions recorded.
